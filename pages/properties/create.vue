<template>
  <div>
    ...
    <form v-else @submit.prevent="store" class="mb-5">
      <b-row>
        <b-col md="12">
          <div class="card mt-3">
            ...
            <div class="card-body">
              <b-row>
                ...
                <b-col md="4">
                  <b-form-group label="Property Category">
                    <select v-model="form.property_category" class="form-control ">
                      <option value="">Select</option>
              ...
              <b-row>
                ...
                <b-col md="4">
                  <b-form-group label="Select division">
                    <select @change="getDistricts" v-model="form.division_id" class="form-control ">
                ...
                <b-col md="4">
                  <b-form-group label="Select district">
                    <select @change="getThanas" v-model="form.district_id" class="form-control ">
              ...
              <b-form-group class="mt-3">
                <b-button type="submit" class="btn-browse-more btn-height" variant="info"
                  :disabled="isDisable">Save</b-button>
              </b-form-group>
            </div>
          </div>
        </b-col>
